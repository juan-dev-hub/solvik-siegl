...
import {
  ...
  Home, Store, ChevronRight, Settings,
} from 'lucide-react'
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  // Main nav — internal dashboard pages
  const nav = [
      ...
      <aside style={{ width: 240, background: 'rgba(0,20,60,0.6)', backdropFilter: 'blur(24px)', borderRight: '1px solid rgba(100,200,255,0.1)', display: 'flex', flexDirection: 'column', padding: '24px 0', position: 'fixed', top: 0, left: 0, bottom: 0, zIndex: 40 }}>
        ...
        <nav style={{ flex: 1, padding: '16px 12px', overflowY: 'auto' }}>
          ...
          <Accordion label="Cuenta" icon={<Settings size={15} />}>
            ...
            <a href="/dashboard/sns" style={{ ...linkStyle, background: pathname === '/dashboard/sns' ? 'rgba(74,186,255,0.08)' : 'none', color: pathname === '/dashboard/sns' ? '#4ABAFF' : 'rgba(180,210,255,0.5)' }}>
              <Globe size={15} />
