  ...
  return (
    <div style={{ minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '60px 40px' }}>
        <h1 style={{ fontFamily: 'Nunito, sans-serif', fontWeight: 800, fontSize: 36, color: '#F0F8FF', marginBottom: 32 }}>
          {t.terms.title}
        </h1>
        ...
        <div style={{ border: '2px solid rgba(255,229,102,0.6)', background: 'rgba(255,229,102,0.06)', borderRadius: 16, padding: '20px 24px', marginBottom: 40, display: 'flex', gap: 16 }}>
          ...
          <p style={{ fontSize: 15, color: '#FFE566', fontFamily: 'Inter, sans-serif', lineHeight: 1.7, fontWeight: 600 }}>
            {t.terms.warning}
          </p>
        </div>
        ...
        {t.terms.sections.map((s, i) => (
          <div key={i} style={{ marginBottom: 32 }}>
            <h2 style={{ fontFamily: 'Nunito, sans-serif', fontWeight: 700, fontSize: 16, color: '#4ABAFF', marginBottom: 12 }}>
              {i + 1}. {s.title}
            </h2>
            <p style={{ fontSize: 15, color: 'rgba(180,210,255,0.75)', fontFamily: 'Inter, sans-serif', lineHeight: 1.8 }}>
              {s.body}
            </p>
          </div>
        ))}
