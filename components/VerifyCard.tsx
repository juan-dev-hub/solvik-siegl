        ...
        <div className="glass-card" style={{ maxWidth: 560, width: '100%' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
            <div style={{ background: 'rgba(82,200,120,0.15)', border: '1px solid #52C878', borderRadius: 50, padding: '8px 20px', display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <span style={{ color: '#52C878', fontWeight: 700, fontFamily: 'Luna, sans-serif', fontSize: 14 }}>
          ...
          <div style={{ marginBottom: 20 }}>
            ...
            <p style={{ fontFamily: 'Luna, sans-serif', fontWeight: 700, fontSize: 20, color: '#F0F8FF' }}>
          ...
          <div style={{ marginBottom: 20 }}>
            ...
            <p style={{ fontSize: 18, fontWeight: 600, color: '#F0F8FF', fontFamily: 'Luna, sans-serif' }}>{cert.issued_to}</p>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 24 }}>
            <div>
              ...
              <p style={{ color: 'rgba(180,210,255,0.8)', fontFamily: 'Luna, sans-serif', fontSize: 14 }}>{cert.doc_type}</p>
            </div>
            <div>
              <p className="section-title">{t.verify.issued}</p>
              <p style={{ color: 'rgba(180,210,255,0.8)', fontFamily: 'Luna, sans-serif', fontSize: 14 }}>
          ...
          <div style={{ border: '1px solid rgba(180,210,255,0.12)', borderRadius: 12, padding: '14px 18px', background: 'rgba(0,20,60,0.3)' }}>
            <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
              ...
              <p style={{ fontSize: 12, color: 'rgba(180,210,255,0.45)', fontFamily: 'Luna, sans-serif', lineHeight: 1.6 }}>
                {t.verify.disclaimer}
              </p>
            </div>
          </div>

          <p style={{ textAlign: 'center', marginTop: 20, fontSize: 11, color: 'rgba(180,210,255,0.25)', fontFamily: 'Luna, sans-serif' }}>
            {t.verify.powered}
          </p>
        </div>
      </div>
